<?php
$service = new service(
    'b5p4ii64e7ycMLLdBiiIIV5HAkSyxpj7', // Вставьте свой аккаунт\идентификатор для интеграции
    'Pi7vtvxdlZrASBYDjH7iuV1Td7HFPMnC'  // Вставьте свой пароль для интеграции
);
