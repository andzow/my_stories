  ...
  <section class="header">
    <div class="header__container">
      <div class="header__name">
        ...
        <NuxtLink
          to="/"
          class="header__title_special"
          @click="useCheckedAuth = true"
          >MY STORIES...</NuxtLink
        >
      </div>
      <div class="header__icons">
        ...
        <img
          class="header__loop"
          src="~/assets/images/Admin/loop.svg"
          alt=""
        ...
        <img
          ...
          @click="(useStatus = 'logout'), (useCheckedAuth = false)"
          alt=""
        />
      </div>
    </div>
  ...
  methods: {
    async search() {
      await this.$router.push({
        path: "/admin",
        query: { ...this.$route.query, name: this.isName, page: 1 },
      });
