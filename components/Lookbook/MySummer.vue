<template>
	<section class="summer">
		<div class="summer__content">
			<div class="summer__about">
				<div class="summer__about_information">
					...
					<p class="summer__about_text">
						в новую коллекцию вошли лёгкие платья из муслина, варёного хлопка,
						вискозы, батиста, брючные комплекты и сарафаны из крапивы, юбки и
						блузы из тенселя, рубашки из хлопка в традиционную клетку-виши.<br /><br />
						чтобы каждый день лета был наполнен комфортом и ощущением
						внутреннего спокойствия, мы подобрали сдержанную палитру цветов:
						нежные оттенки пастели, спокойная горчица, натуральный хаки,
						небесный голубой...
					</p>
					<div class="summer__mobile">
						<img
							class="summer__mobile_img"
			...
			<div class="summber__about_mobile">
				<div class="summer__about_img">
					<img
						class="summer__about_item"
						src="@/assets/images/Lookbook/summer1.webp"
						alt="Фотографии коллекции летний ветер ..."
						width="574"
						height="602"
				...
				<div class="summer__about_photo">
					<img
						class="summer__about_image"
...
export default {
	...
	mounted() {
		if (window.innerWidth > 1240) {
			...
			this.useGsapAnimationOpacity(['.summer'], '.summer')
		}
	},
}
</script>
