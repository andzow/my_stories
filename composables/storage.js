...
export const useWidth = () => useState("use_width", () => '');
export const useHeight = () => useState("use_height", () => '');
export const useLenght = () => useState("use_lenght", () => '');
export const useWeight = () => useState("use_weight", () => '');
